...
jsPsych.plugins["audio-audio-response"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        if(typeof trial.audio_stimulus === 'undefined'){
            console.error('Required parameter "audio_stimulus" missing in audio-audio-response');
        }
        ...
        html += '<div id="jspsych-audio-audio-response-buttons"><button id="jspsych-audio-audio-response-rerecord" class="jspsych-audio-response-button jspsych-btn" style="display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'; visibility:hidden;">Retry</button><button id="jspsych-audio-audio-response-okay" class="jspsych-audio-response-button jspsych-btn" style="display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'; visibility:hidden;">Okay</button></div>';
        ...
        function start_trial() {
            ...
            if (trial.stimulus_duration !== null) {
                jsPsych.pluginAPI.setTimeout(function() {
                    display_element.querySelector('#jspsych-audio-audio-response-stimulus').style.visibility = 'hidden';
        ...
        var after_response = function(info){
            ...
            //display_element.querySelector('#jspsych-audio-audio-response-stimulus').className += ' responded';
        ...
        function showPlaybackTools(data) {
            // Audio Player
            let playerDiv = display_element.querySelector('#jspsych-audio-audio-response-audio-container');
            let url;
            ...
            let player = playerDiv.querySelector('#jspsych-audio-audio-response-audio');
            player.src = url;
            player.style.visibility = "visible";
            // Okay/rerecord buttons
            let buttonDiv = document.querySelector('#jspsych-audio-audio-response-buttons');
            let rerecord = buttonDiv.querySelector('#jspsych-audio-audio-response-rerecord');
            let okay = buttonDiv.querySelector('#jspsych-audio-audio-response-okay');
        ...
        function onRecordingFinish(data) {
            ...
            let light = document.querySelector('#jspsych-audio-audio-response-recording-container');
            if (light !== null)
